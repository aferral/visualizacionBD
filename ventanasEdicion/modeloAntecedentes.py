...
class vistaAntecedentes:
    def __init__(self,parent):
        ...
        cont.add(ttk.Combobox,"Adiccion",True,state='readonly').grid(row=0,column=2)
        cont.grid(row=0,column=1)
        ...
        Label(self.groupComentario.interior(),text = 'Comentario:').grid(row=0,column=1,sticky=W, padx=5, pady=5)
       ...
       #########################################################################
        ...
        Entry(self.group3.interior(), textvariable = self.varOperation).grid(row=1,column=2)

        Label(self.group3.interior(), text = 'Doctor:').grid(row=2,column=1,sticky=W, padx=5, pady=5)

        Entry(self.group3.interior(), textvariable = self.varDr).grid(row=2,column=2)
